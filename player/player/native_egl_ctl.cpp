...
Java_com_lantonda_mediaplayer_LTDMediaPlayer_nativeGetPlayState(JNIEnv *env, jobject instance)
{
    UNUSED(env);
    UNUSED(instance);
    return MediaServiceIFace::instance()->getPlayState();
}
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lantonda_mediaplayer_LTDMediaPlayer_nativeGetCurrentPosition(JNIEnv *env, jobject instance)
{
    UNUSED(env);
    UNUSED(instance);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lantonda_mediaplayer_LTDMediaPlayer_nativeGetDuration(JNIEnv *env, jobject instance)
{
    UNUSED(env);
    UNUSED(instance);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_lantonda_mediaplayer_LTDMediaPlayer_nativeSetSubtitle(JNIEnv *env, jobject instance, jboolean looping)
{
    UNUSED(looping);
    UNUSED(env);
    UNUSED(instance);
    MediaServiceIFace::instance()->setSubtitle(looping);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_lantonda_mediaplayer_LTDMediaPlayer_nativeSetVolume(JNIEnv *env, jobject instance, jfloat leftVolume, jfloat rightVolume)
{
...
/**
2020年 04月 24日 星期五 14:34:43 CST
 detele :
  setLooping
  isLooping
  isPlaying
 ...
 add:
 getPlayState
 setSubtitle(bool) 使能字幕，如果当前媒体有字幕发出
